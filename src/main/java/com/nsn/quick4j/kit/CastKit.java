...
public class CastKit {
     ...
     * 转化为float，提供默认值
     */
    public static double castFloat(Object obj, float defaultValue) {
		/*
		 * 判断obj是否为空
		 * 考虑double格式字符串
		 * 先转为字符串，注意考虑类型转化失败异常
     ...
     * 转化为float，默认值0
     */
    public static double castFloat(Object obj) {
    ...
    public static String[] castStringArray(Object[] objArray) {
        ...
        //判断非空以及长度非0
        if (ArrayKit.isNotEmpty(objArray)) {
    ...
    public static Integer[] castIntegerArray(Object[] objArray) {
		/*
		 * 判断objArray是否为空，为空初始化0长度
		 * 非空开始转换
		 */
